...
% Backpage 5 with References on it: go wild with LaTeX Biblio or KISS?
...
\item[The Linux Programming Environment, Kernighan and Pike, Prentice
  Hall, 1984] An earky catch-all book, about the size and complexity
  of K\&R C Programming Language, that covers shell, C Programming,
  lex and yacc. Like K\&R C it assumes you know what you're doing and
...
% Add The UNIX Programming Environment by Kernighan and Pike? Sobell?
