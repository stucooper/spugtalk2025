...
datastore's API documentation was in Perl. The same shop was using
...
will reinvigorate interest in the language. When that happens,
existing Perl people will be well positioned to ride the cusp of the
New Wave, and install Perl on Windows for the next generation of
ADAMKs.
...
this week's challenge on Facebook.
...
\item[The UNIX Programming Environment, Kernighan and Pike, Prentice
